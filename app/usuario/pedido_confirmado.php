...
$venda = mysqli_query($conn, "SELECT * FROM vendas WHERE id_venda = $id_venda AND id_clientes = $id_cliente");
$v = mysqli_fetch_assoc($venda);
...
<div style="max-width:800px;margin:0 auto;text-align:center">
  <div class="cartao" style="border:3px solid #2e7d32;padding:40px">
    <h1 style="color:#2e7d32">Pedido Confirmado!</h1>
    <p style="font-size:18px;margin:16px 0">Obrigado por comprar no MixTudo!</p>
    <p style="font-size:14px;color:#666">Nº do pedido: <strong>#<?php echo $id_venda; ?></strong></p>
    <p style="font-size:14px;color:#666">Data: <?php echo date('d/m/Y', strtotime($v['data_venda'])); ?></p>
  </div>
  ...
  <div class="cartao" style="text-align:left">
    ...
    <p style="text-align:right;font-size:20px;font-weight:700;margin-top:16px">
      Total: R$ <?php echo number_format($v['total'], 2, ',', '.'); ?>
    </p>
  </div>
